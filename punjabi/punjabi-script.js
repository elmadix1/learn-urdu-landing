/* OURDOUACADEMY · PUNJABI AFTER URDU */
...
(function() {
    ...
    if (p2 && p3) {
        gsap.fromTo(p2, { opacity: 0.5 }, { opacity: 0, immediateRender: false, ease: 'none', scrollTrigger: { trigger: '#transformation', start: 'top 85%', end: 'bottom 40%', scrub: 1.5 } });
        gsap.fromTo(p3, { opacity: 0 }, { opacity: 0.4, ease: 'none', scrollTrigger: { trigger: '#transformation', start: 'top 85%', end: 'bottom 40%', scrub: 1.5 } });
        gsap.fromTo('#bg-photo-3 img', { scale: 1.1 }, { scale: 1, ease: 'none', scrollTrigger: { trigger: '#transformation', start: 'top 80%', end: 'bottom 30%', scrub: 2 } });
    }
    if (p3) {
    ...
    if (bgPat) {
        gsap.fromTo(bgPat, { opacity: 0 }, { opacity: 0.06, ease: 'none', scrollTrigger: { trigger: '#unlocks', start: 'top 80%', end: 'bottom 50%', scrub: 1 } });
        gsap.to(bgPat, { opacity: 0.14, ease: 'none', scrollTrigger: { trigger: '#transformation', start: 'top 80%', end: 'bottom 30%', scrub: 1 } });
